		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Data",
									"targetURL": "#comsceepportalenterpriseprocurementportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsceepportalenterpriseprocurementportal-display": {
								"semanticObject": "comsceepportalenterpriseprocurementportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sce.epportal.enterpriseprocurementportal",
									"url": sap.ui.require.toUrl("com/sce/epportal/enterpriseprocurementportal")
								}
							}
						}
					}
